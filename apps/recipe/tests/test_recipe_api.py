...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        # Save ingredient2 to the database
        ingredient2 = Ingredient.objects.create(user=self.user, name="pepper")

        # Update the recipe to assign ingredient "pepper" instead of "chili"
        ...
        # Check if ingredient2 (Pepper) is now in the recipe's ingredients list
        self.assertIn(ingredient2, recipe.ingredients.all())
        # Ensure ingredient1 (Chili) is no longer in the recipe's ingredients
